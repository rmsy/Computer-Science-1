...
public class Text18
{
  public static void main(String[] args)
  {
    ...
    try {
      file = new FileReader("../../Resources/JavaText4/distance.dat");
    ...
    x[1] = fr.nextDouble();
    y[1] = fr.nextDouble();
    System.out.printf("The distance between points (%d, %d) and (%d, %d) = %.4f\n", (int) x[0], (int) y[0], (int) x[1], (int) y[1], Math.sqrt(((y[1] - y[0]) * (y[1] - y[0])) + ((x[1] - x[0]) * (x[1] - x[0]))));
    try {
      file.close();
